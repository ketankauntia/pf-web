...
// Preview/External Link Icon Component
const PreviewIcon = () => (
            ...
            <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="project-item-right-img flex-shrink-0 flex flex-col mt-6 items-center">
                    ...
                    <div className="project-links mt-3 flex justify-center items-center gap-2">
                        <Button type="secondary" href={project.previewLink} icon={<PreviewIcon />}>Preview</Button>
                        <Button type="primary" href={project.githubLink} icon={<GitHubIcon />}>GitHub</Button>
                    </div>
                </div>
            </div>
        </div>
